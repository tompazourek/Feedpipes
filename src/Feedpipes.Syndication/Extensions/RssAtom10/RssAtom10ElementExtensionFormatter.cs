...
{
    internal static class RssAtom10ElementExtensionFormatter
    {
        public static bool TryFormatRssAtom10ElementExtension(RssAtom10ElementExtension extensionToFormat, XNamespaceAliasSet namespaceAliases, out IList<XElement> elements)
        {
            elements = default;
        ...
        private static bool TryFormatRssAtom10TextElement(string valueToFormat, string elementName, XNamespaceAliasSet namespaceAliases, out XElement element)
        {
            ...
            namespaceAliases.EnsureNamespaceAlias(RssAtom10Constants.NamespaceAlias, RssAtom10Constants.Namespace);
            element = new XElement(RssAtom10Constants.Namespace + elementName) { Value = valueToFormat };
            return true;
        }
        ...
        private static bool TryFormatRssAtom10Timestamp(DateTimeOffset? valueToFormat, string elementName, XNamespaceAliasSet namespaceAliases, out XElement element)
        {
            ...
            namespaceAliases.EnsureNamespaceAlias(RssAtom10Constants.NamespaceAlias, RssAtom10Constants.Namespace);
            element = new XElement(RssAtom10Constants.Namespace + elementName) { Value = valueString };
        ...
        private static bool TryFormatRssAtom10Link(Atom10Link linkToFormat, XNamespaceAliasSet namespaceAliases, out XElement linkElement)
        {
            ...
            namespaceAliases.EnsureNamespaceAlias(RssAtom10Constants.NamespaceAlias, RssAtom10Constants.Namespace);
            linkElement = new XElement(RssAtom10Constants.Namespace + "link");
